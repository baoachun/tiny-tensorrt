...
PYBIND11_MODULE(pytrt, m)
{
    ...
    py::class_<Trt>(m, "Trt")
        ...
        .def("CreateEngine", (void (Trt::*)(const std::string &, const std::string &, const std::string &, const std::vector<std::string> &, int, int)) & Trt::CreateEngine, "create engine with caffe model")
        .def("CreateEngine", (void (Trt::*)(const std::string &, const std::string &, const std::vector<std::string> &, int, int)) & Trt::CreateEngine, "create engine with onnx model")
        .def("CreateEngine", (void (Trt::*)(const std::string &, const std::string &, const std::vector<std::string> &, const std::vector<std::vector<int>> &, const std::vector<std::string> &, int, int)) & Trt::CreateEngine, "create engine with tensorflow model")
        .def("Forward", (void (Trt::*)()) & Trt::Forward, "inference")
        .def("SetDevice", (void (Trt::*)(int)) & Trt::SetDevice, "set building and inference device")
